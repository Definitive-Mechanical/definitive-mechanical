    ...
    <div className="min-h-screen">
      ...
      <section style={{ minHeight: "50vh", position: "relative", overflow: "hidden", background: "#111" }} className="py-20 md:py-28">
        ...
        <div className="container" style={{ position: "relative", zIndex: 1 }}>
          ...
          <p className="mt-6 mb-3 uppercase tracking-widest text-xs font-bold" style={{ color: "var(--brand-cyan)", fontFamily: 'var(--font-label)' }}>Commercial Plumbing  Northern Virginia  Fairfax  Arlington  Loudoun  Prince William</p>
          ...
          <div className="flex flex-wrap gap-4 mb-10">
            ...
            <BookNowButton bg="dark" variant="secondary" text="REQUEST NOVA COMMERCIAL ESTIMATE" href="/contact/" size="lg" />
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-10">
            {NOVA_MARKETS.map(m => (
              <div key={m.title} className="p-6 rounded-lg border border-gray-100 hover:shadow-md transition-shadow">
                ...
                <h3 className="font-bold text-sm uppercase tracking-wide mb-2" style={{ color: "var(--brand-blue)", fontFamily: 'var(--font-label)' }}>{m.title}</h3>
                <p className="text-sm" style={{ color: "var(--ink-2)", fontFamily: 'var(--font-body)', lineHeight: 1.6 }}>{m.detail}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16" style={{ background: "var(--surface-1)" }}>
        <div className="container max-w-4xl">
          ...
          <div className="mt-8 p-8 bg-white rounded-lg shadow-sm">
            ...
            <a href="/swam-certified-plumbing-contractor-virginia/" className="inline-block font-bold underline" style={{ color: "var(--brand-blue)", fontFamily: 'var(--font-label)' }}>
      ...
      <section className="py-16 bg-white">
        <div className="container max-w-4xl">
          ...
          <div className="mt-8 space-y-4">
            ...
            <a href="/government-municipal-plumbing/" className="inline-block font-bold underline" style={{ color: "var(--brand-blue)", fontFamily: 'var(--font-label)' }}>
      ...
      <section className="py-16" style={{ background: "var(--surface-1)" }}>
        <div className="container max-w-4xl">
          ...
          <div className="mt-8 grid md:grid-cols-2 gap-8">
            <div className="p-6 rounded-lg bg-white" style={{ border: "2px solid var(--brand-blue)" }}>
              <h3 className="font-bold text-lg mb-4" style={{ color: "var(--brand-blue)", fontFamily: 'var(--font-label)', textTransform: "uppercase" }}>Virginia License Portfolio</h3>
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={d.title} className="flex gap-4 p-4 bg-white rounded-lg">
                  ...
                  <div>
                    <h3 className="font-bold text-sm mb-1" style={{ color: "var(--brand-blue)", fontFamily: 'var(--font-label)', textTransform: "uppercase" }}>{d.title}</h3>
      ...
      <section className="py-16" style={{ background: "var(--brand-blue)" }}>
        <div className="container text-center">
          ...
          <p className="text-white/60 text-sm mb-8" style={{ fontFamily: 'var(--font-body)' }}>VA Master Plumber #2710064209 | SWaM Cert 815255 | CAGE 8HCF6</p>
          <div className="flex flex-wrap justify-center gap-4">
            <BookNowButton bg="blue" variant="phone" text="CALL (301) 679-5849" href="tel:+13016795849" size="lg" />
            <BookNowButton bg="blue" variant="secondary" text="REQUEST NOVA COMMERCIAL ESTIMATE" href="/contact/" size="lg" />
          </div>
        </div>
      </section>
    </div>
