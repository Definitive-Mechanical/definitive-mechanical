        ...
        <div className="container">
          ...
          <div className="bg-white border-l-4 rounded-md p-4 max-w-xl mx-auto mt-6" style={{ borderColor: "var(--brand-cyan)" }}>
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm" style={{ color: "var(--brand-blue)", fontFamily: "'Barlow', sans-serif" }}>Our office is at 9701 Apollo Drive, Suite 100, Largo, MD 20774. Emergency dispatch for Largo addresses starts from your community.</p>
            </div>
          </div>
        </div>
      </section>
