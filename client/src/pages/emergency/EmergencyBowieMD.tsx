...
const EMERGENCY_STEPS = [
  ...
  { number: 2, title: "Licensed Plumber Dispatched from Largo", description: "Licensed plumbing professionals dispatched — work performed under Master Plumber license. Our Largo, MD base is just minutes from most Bowie neighborhoods via Central Avenue and MD-50. Our dispatcher gives you an honest ETA at the time of your call.", icon: "Truck" },
    ...
    <>
      ...
      <section style={{ background: "linear-gradient(135deg, var(--brand-navy) 0%, var(--brand-navy) 100%)", minHeight: "55vh" }} className="flex items-center py-16">
        <div className="container text-center">
          ...
          <p className="mt-6 mb-3 uppercase tracking-widest text-xs font-bold" style={{ color: "var(--brand-cyan)", fontFamily: 'var(--font-label)' }}>24/7 EMERGENCY PLUMBER  BOWIE, MD  PRINCE GEORGE'S COUNTY</p>
      ...
      <section style={{ backgroundColor: "#fff" }} className="py-14">
        <div className="container">
          <SectionHeading eyebrow="LICENSE PROOF" heading="WSSC and Maryland Licensed for Bowie Emergency Plumbing" />
          ...
          <p className="text-white/70 text-center text-sm mt-4 max-w-2xl mx-auto" style={{ fontFamily: 'var(--font-body)' }}>Bowie is served by WSSC (Washington Suburban Sanitary Commission). Our WSSC license #73696 authorizes all permitted plumbing work in the WSSC service territory covering Bowie.</p>
        </div>
      </section>
