    ...
    <>
      ...
      <section style={{
        ...
        <div style={{ position: 'absolute', inset: 0, zIndex: 0 }}>
          <img
            src="/images/service-faucet-fixture.webp"
      ...
      <section style={{ background: 'var(--brand-navy)', padding: '80px 0' }}>
        <div className="container">
          ...
          <h2 style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 'clamp(24px,3vw,38px)', textTransform: 'uppercase', color: 'white', lineHeight: 1.05, marginBottom: '16px' }}>Questions about faucet and toilet repair in MD, DC & Northern VA</h2>
        </div>
