    ...
    <>
      ...
      <section style={{
        ...
        <div style={{ position: 'absolute', inset: 0, zIndex: 0 }}>
          <img
            src="/manus-storage/service-video-camera-inspection_a80ee887.webp"
          ...
          <div className="grid lg:grid-cols-1 gap-12 items-center mt-6" style={{ maxWidth: '720px' }}>
            <div className="">
              ...
              <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', marginTop: '32px' }}>
                ...
                <BookNowButton bg="dark" variant="secondary" text="REQUEST CAMERA INSPECTION" href="/contact" size="md" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <BookNowButton bg="light" variant="phone" text="CALL TO SCHEDULE INSPECTION" href="tel:+13016795849" size="md" />
            </div>
            <div>
