    ...
    <>
      ...
      <section className="bg-[var(--brand-navy)] py-14 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <a
            href={`tel:${PHONE}`}
            className="inline-flex items-center justify-center gap-2 bg-[var(--brand-cyan)] text-[var(--brand-navy)] font-['Barlow_Condensed'] font-bold text-xl uppercase tracking-wide py-5 px-10 rounded-sm hover:bg-[var(--brand-blue-2)] transition-colors mb-8"
          >
            <Phone className="w-5 h-5" />
