  ...
  return (
    <>
      ...
      <a href="tel:+13016795849" style={{ background: '#C0392B', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', padding: '14px 16px', textDecoration: 'none', flexWrap: 'wrap' }}>
        ...
        <span style={{ fontFamily: 'Barlow Condensed, Arial, sans-serif', fontWeight: 700, color: 'white', fontSize: '14px', textTransform: 'uppercase', letterSpacing: '0.05em', textAlign: 'center' }}>
      ...
      {/* SECTION 1: HERO */}
      <section style={{ minHeight: '55vh', background: 'linear-gradient(135deg, #001830 0%, #003060 100%)', display: 'flex', alignItems: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative w-full">
          ...
          <div className="grid lg:grid-cols-5 gap-12 items-center mt-6">
            <div className="lg:col-span-3">
              ...
              <h1 style={{ fontFamily: 'Playfair Display, Georgia, serif', fontWeight: 700, color: 'white', fontSize: 'clamp(24px, 3.5vw, 40px)', lineHeight: 1.15, marginBottom: '20px' }}>
              ...
              <div style={{ background: 'rgba(255,255,255,0.08)', border: '2px solid rgba(255,180,0,0.5)', borderRadius: '6px', padding: '24px', marginBottom: '24px', maxWidth: '560px' }}>
                ...
                <p style={{ fontFamily: 'Barlow Condensed, Arial, sans-serif', fontWeight: 700, color: '#F59E0B', fontSize: '14px', textTransform: 'uppercase', letterSpacing: '0.1em', textAlign: 'center', marginBottom: '12px' }}>⚠️ IF YOU SMELL GAS RIGHT NOW:</p>
                <div className="space-y-2">
                  {["Leave the building immediately — do not turn any lights or switches on or off", "Do not use your phone inside the building", "Once safely outside, call your gas company's emergency line", "Call 911 if there is any active danger", "Once the gas company has responded and shut off supply, call Definitive Mechanical"].map((item, i) => (
                    <div key={item} style={{ display: 'flex', gap: '10px', alignItems: 'flex-start' }}>
                      <span style={{ fontFamily: 'Barlow Condensed, Arial, sans-serif', fontWeight: 700, color: '#F59E0B', fontSize: '14px', flexShrink: 0, minWidth: '18px' }}>{i + 1}.</span>
                      <span style={{ fontFamily: 'Barlow, Arial, sans-serif', color: 'white', fontSize: '14px', lineHeight: 1.5 }}>{item}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              {/* Dominant phone CTA */}
              <a href="tel:+13016795849" style={{ background: '#009EC6', borderRadius: '4px', padding: '20px 24px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px', textDecoration: 'none', width: '100%', maxWidth: '560px', marginBottom: '20px' }}>
                <Phone size={24} color="#003060" />
                <span style={{ fontFamily: 'Barlow Condensed, Arial, sans-serif', fontWeight: 700, color: '#003060', fontSize: '18px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>CALL (301) 679-5849 — EMERGENCY GAS REPAIR, 24/7</span>
              </a>

              <p style={{ fontFamily: 'Barlow, Arial, sans-serif', color: 'rgba(255,255,255,0.8)', fontSize: '16px', lineHeight: 1.7, maxWidth: '560px', marginBottom: '12px' }}>
              ...
              <p style={{ fontFamily: 'Barlow Condensed, Arial, sans-serif', fontWeight: 700, color: 'rgba(255,255,255,0.65)', fontSize: '12px', textTransform: 'uppercase', letterSpacing: '0.1em' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl mx-auto">
            {[
              ...
              <div key={title} style={{ background: 'white', borderTop: '3px solid #F59E0B', borderRadius: '4px', padding: '20px', border: '1px solid #E8EFF5' }}>
                ...
                <p style={{ fontFamily: 'Barlow, Arial, sans-serif', fontWeight: 600, color: '#003060', fontSize: '14px', marginBottom: '6px' }}>{title}</p>
                <p style={{ fontFamily: 'Barlow, Arial, sans-serif', color: '#484848', fontSize: '13px', lineHeight: 1.6 }}>{body}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ background: '#003060', padding: '64px 0' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p style={{ fontFamily: 'Barlow, Arial, sans-serif', color: 'rgba(255,255,255,0.8)', fontSize: '16px', lineHeight: 1.7, maxWidth: '720px', margin: '0 auto 32px' }}>
          ...
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', justifyContent: 'center' }}>
            {["MD #96958", "DC #PGM1002236", "VA #2710064209", "DE #PL-0012866"].map((badge) => (
              <div key={badge} style={{ background: 'white', color: '#003060', fontFamily: 'Barlow Condensed, Arial, sans-serif', fontWeight: 700, fontSize: '14px', letterSpacing: '0.08em', padding: '10px 20px', borderRadius: '4px' }}>{badge}</div>
            ))}
          </div>
        </div>
      </section>
