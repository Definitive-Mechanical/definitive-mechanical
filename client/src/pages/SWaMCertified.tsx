              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-start gap-3 p-4 rounded" style={{ background: "var(--surface-1)" }}>
                    ...
                    <div>
                      <p style={{ fontFamily: 'var(--font-display)', fontWeight: 700, color: '#0A0A0A', fontSize: "11px", textTransform: "uppercase", letterSpacing: "0.15em" }}>{item.label}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
            {[
              ...
              <div key={i} className="bg-white rounded-md p-6" style={{ boxShadow: "0 2px 12px rgba(0,0,0,0.15)" }}>
                ...
                <p style={{ fontFamily: 'var(--font-display)', fontWeight: 700, color: '#0A0A0A', fontSize: "14px", textTransform: "uppercase", letterSpacing: "0.1em" }} className="mb-3">{item.title}</p>
