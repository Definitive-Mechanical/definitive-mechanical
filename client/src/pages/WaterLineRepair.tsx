...
export default function WaterLineRepair() {
  return (
    <>
      {/* SECTION 1: HERO */}
      <section style={{ minHeight: '55vh', background: 'linear-gradient(135deg, #003060 0%, #001830 100%)', display: 'flex', alignItems: 'center', position: 'relative', overflow: 'hidden' }}>
      ...
      <section style={{ background: 'white', padding: '80px 0' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div>
              <p style={{ fontFamily: 'Barlow, Arial, sans-serif', fontWeight: 600, color: '#003060', fontSize: '15px', marginBottom: '16px' }}>Warning signs:</p>
            ...
            {/* Emergency strip */}
            <div style={{ background: '#003060', borderRadius: '6px', padding: '24px', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
              <Phone size={32} color="#009EC6" style={{ marginBottom: '12px' }} />
              <p style={{ fontFamily: 'Barlow Condensed, Arial, sans-serif', fontWeight: 700, color: 'white', fontSize: '16px', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '12px' }}>ACTIVE WATER LINE FAILURE?</p>
              <p style={{ fontFamily: 'Barlow, Arial, sans-serif', color: 'rgba(255,255,255,0.8)', fontSize: '14px', lineHeight: 1.7, marginBottom: '20px' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {[
              ...
              <div key={title} style={{ background: 'white', borderTop: '4px solid #009EC6', borderRadius: '6px', padding: '24px', boxShadow: '0 2px 8px rgba(0,48,96,0.06)' }}>
                <Icon size={36} color="#009EC6" style={{ marginBottom: '12px' }} />
                <p style={{ fontFamily: 'Barlow, Arial, sans-serif', fontWeight: 600, color: '#003060', fontSize: '15px', marginBottom: '8px' }}>{title}</p>
                <p style={{ fontFamily: 'Barlow, Arial, sans-serif', color: '#484848', fontSize: '14px', lineHeight: 1.6 }}>{body}</p>
              </div>
            ))}
          </div>
          {/* WSSC Note */}
          <div style={{ background: '#C0D8F0', borderRadius: '6px', padding: '20px', maxWidth: '640px', margin: '32px auto 0', display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
            <Info size={20} color="#186090" style={{ flexShrink: 0, marginTop: '2px' }} />
            <p style={{ fontFamily: 'Barlow, Arial, sans-serif', color: '#484848', fontSize: '14px', lineHeight: 1.6 }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h2 style={{ fontFamily: 'Playfair Display, Georgia, serif', fontWeight: 700, color: '#003060', fontSize: 'clamp(20px, 2.5vw, 26px)', marginBottom: '24px' }}>What does water line repair cost?</h2>
              <div style={{ background: 'white', border: '1px solid #E8EFF5', borderRadius: '6px', overflow: 'hidden', marginBottom: '16px' }}>
                <div style={{ background: '#003060', padding: '10px 16px', display: 'grid', gridTemplateColumns: '1fr 1fr' }}>
                  <span style={{ fontFamily: 'Barlow Condensed, Arial, sans-serif', fontWeight: 700, color: 'white', fontSize: '11px', textTransform: 'uppercase', letterSpacing: '0.1em' }}>REPAIR TYPE</span>
                  <span style={{ fontFamily: 'Barlow Condensed, Arial, sans-serif', fontWeight: 700, color: 'white', fontSize: '11px', textTransform: 'uppercase', letterSpacing: '0.1em' }}>TYPICAL RANGE</span>
                </div>
                {PRICING_ROWS.map((row, i) => (
                  <div key={row.type} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', padding: '11px 16px', background: i % 2 === 0 ? 'white' : '#F8FAFC', borderTop: '1px solid #E8EFF5' }}>
                    <span style={{ fontFamily: 'Barlow, Arial, sans-serif', color: '#484848', fontSize: '13px' }}>{row.type}</span>
                    <span style={{ fontFamily: 'Barlow, Arial, sans-serif', fontWeight: 600, color: '#003060', fontSize: '13px' }}>{row.range}</span>
                  </div>
                ))}
              </div>
              <p style={{ fontFamily: 'Barlow, Arial, sans-serif', color: '#787878', fontSize: '13px', fontStyle: 'italic', lineHeight: 1.6, marginBottom: '20px' }}>
            ...
            <div>
              <img src="https://images.unsplash.com/photo-1621905251189-08b45d6a269e?w=600&q=80" alt="Water line repair cost guide Maryland DC Virginia" style={{ width: '100%', borderRadius: '6px', boxShadow: '0 4px 20px rgba(0,48,96,0.12)' }} />
            </div>
          </div>
        </div>
      </section>
