...
const PRICING_ROWS = [
  { type: "Accessible pipe section repair", range: "$1,000-$3,000" },
  { type: "Excavation and spot repair", range: "$12,000+" },
  { type: "Full service line replacement (residential)", range: "$15,000-$35,000" },
  { type: "Emergency response and containment", range: "$500-$3,000" },
];
  ...
  return (
    <>
      ...
      <section style={{ background: '#F0F5FA', padding: '80px 0' }}>
        <div className="container">
          <div style={{ marginBottom: '40px' }}>
          <p style={{ fontFamily: 'var(--font-eyebrow)', fontWeight: 700, fontSize: '11px', textTransform: 'uppercase', letterSpacing: '0.2em', color: 'var(--brand-cyan)', marginBottom: '8px' }}>CAUSES</p>
