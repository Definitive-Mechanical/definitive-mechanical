    ...
    <>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-8 items-center">
            ...
            <div className="hidden lg:block">
              <img src="https://d2xsxph8kpxj0f.cloudfront.net/98106163/Mxa9FkjQjimhEb95Dyj8bk/city-page-hero-plumber-LiK4eLEJT6Nfxt9Ly3GS3e.webp" alt="Licensed plumber Potomac Maryland — Definitive Mechanical estate home service" loading="eager" className="rounded-lg w-full" style={{ objectFit:"cover", height:"420px" }} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ background:"#F4F7FA" }} className="py-16">
        <div className="container">
          ...
          <h2 style={{ fontFamily:"var(--font-display)", color:"var(--brand-blue)", fontSize:"clamp(22px,3vw,32px)", fontWeight:700, textTransform:"uppercase", lineHeight:1.1 }} className="mb-6">Areas Near Potomac, MD We Also Serve</h2>
          <div className="flex flex-wrap gap-2 mb-6">
            ...
            <a key="Rockville, MD" href="/service-areas/maryland/montgomery-county/rockville-md" style={{ fontFamily:"var(--font-body)", fontSize:"14px", fontWeight:500, color:"var(--brand-blue)", background:"white", border:"1px solid #D0DCE8", borderRadius:"4px", padding:"6px 14px", textDecoration:"none", transition:"all 0.15s", display:"inline-block" }}>Rockville, MD</a>
            <a key="Chevy Chase, MD" href="/service-areas/maryland/montgomery-county/chevy-chase-md" style={{ fontFamily:"var(--font-body)", fontSize:"14px", fontWeight:500, color:"var(--brand-blue)", background:"white", border:"1px solid #D0DCE8", borderRadius:"4px", padding:"6px 14px", textDecoration:"none", transition:"all 0.15s", display:"inline-block" }}>Chevy Chase, MD</a>
