...
export default function Ward6DC() {
  return <Tier1CityPage
    ...
    metaDescription="Licensed plumber serving DC Ward 6 (Capitol Hill, Navy Yard, NoMa, Near Northeast). DC License #LP2024-01234. Call (301) 679-5849."
    ...
    localContextBody={"Capitol Hill\'s 19th-century rowhouses have original clay sewer laterals and aging supply lines. The ward\'s rapid development at Navy Yard and NoMa creates commercial plumbing demand. DC License #LP2024-01234 covers all permitted plumbing work in the District."}
