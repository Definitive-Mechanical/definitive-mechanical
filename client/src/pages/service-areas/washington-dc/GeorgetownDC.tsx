...
export default function GeorgetownDC() {
  return (
    <Tier1CityPage
      ...
      heroImage="https://d2xsxph8kpxj0f.cloudfront.net/98106163/Mxa9FkjQjimhEb95Dyj8bk/georgetown-dc-XeZtkPGPMCmz8w6pQfnwRm.webp"
      heroImageAlt="Georgetown DC - licensed plumber serving Georgetown Washington DC"
