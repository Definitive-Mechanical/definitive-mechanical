...
export default function CapitolHillDC() {
  return (
    <Tier1CityPage
      ...
      heroImage="https://d2xsxph8kpxj0f.cloudfront.net/98106163/Mxa9FkjQjimhEb95Dyj8bk/capitol-hill-dc-3ir24t8gFpSwX3b4gni7nL.webp"
      heroImageAlt="Capitol Hill DC - licensed plumber serving Capitol Hill Washington DC"
