...
export default function Ward2DC() {
  return <Tier1CityPage
    ...
    metaDescription="Licensed plumber serving DC Ward 2 (Georgetown, Dupont Circle, Logan Circle, Shaw). DC License #LP2024-01234. 24/7 emergency. Call (301) 679-5849."
