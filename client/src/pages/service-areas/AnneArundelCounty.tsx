    ...
    <>
      ...
      <section style={{ minHeight: "45vh", position: "relative", overflow: "hidden", background: "#111" }} className="flex items-center py-16">
        ...
        <div className="container text-center" style={{ position: "relative", zIndex: 1 }}>
          ...
          <p className="mt-6 mb-3 uppercase tracking-widest text-xs font-bold" style={{ color: "var(--brand-cyan)", fontFamily: 'var(--font-label)' }}>PLUMBING SERVICES  ANNE ARUNDEL COUNTY, MD</p>
          ...
          <p className="text-white/85 text-lg max-w-2xl mx-auto mb-8" style={{ fontFamily: 'var(--font-body)' }}>
            Definitive Mechanical is a Licensed Black Owned contractor providing licensed plumbing services throughout Anne Arundel County — Annapolis, Glen Burnie, Severn, Severna Park, and all county communities. Anne Arundel County #A2-6139  MD State #96958. 24/7 emergency. Call (301) 679-5849.
          </p>
      ...
      <section style={{ backgroundColor: "#fff" }} className="py-14">
        <div className="container">
          <SectionHeading eyebrow="CREDENTIALS" heading="Licensed for Anne Arundel County plumbing" />
