    ...
    <>
      ...
      <section style={{ background:"#F4F7FA" }} className="py-16">
        <div className="container">
          ...
          <h2 style={{ fontFamily:"var(--font-display)", color:"var(--brand-blue)", fontSize:"clamp(22px,3vw,32px)", fontWeight:700, textTransform:"uppercase", lineHeight:1.1 }} className="mb-6">Areas Near Vienna We Also Serve</h2>
