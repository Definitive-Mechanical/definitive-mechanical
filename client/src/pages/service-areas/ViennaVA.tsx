...
const faqs = [
  ...
  { question: "Do you provide 24/7 emergency plumbing in Vienna?", answer: "Yes. Emergency service available 24/7. A live dispatcher answers every call. Licensed Virginia Master Plumber dispatched. All services have a trip fee. Call (301) 679-5849." },
    ...
    <>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-8 items-center">
            ...
            <div className="hidden lg:block">
              <img src="https://d2xsxph8kpxj0f.cloudfront.net/98106163/Mxa9FkjQjimhEb95Dyj8bk/city-page-hero-plumber-LiK4eLEJT6Nfxt9Ly3GS3e.webp" alt="Licensed plumber Vienna Virginia — VA Master Plumber #2710064209" loading="eager" className="rounded-lg w-full" style={{ objectFit:"cover", height:"420px" }} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ background:"#F4F7FA" }} className="py-16">
        <div className="container">
          ...
          <h2 style={{ fontFamily:"var(--font-display)", color:"var(--brand-navy)", fontSize:"clamp(22px,3vw,32px)", fontWeight:700, textTransform:"uppercase", lineHeight:1.1 }} className="mb-6">Areas Near Vienna We Also Serve</h2>
          <div className="flex flex-wrap gap-2 mb-6">
            {[{label:"McLean, VA",href:"/service-areas/northern-virginia/fairfax-county/mclean-va"},{label:"Arlington, VA",href:"/service-areas/northern-virginia/arlington-county/arlington-va"},{label:"Springfield, VA",href:"/service-areas/northern-virginia/fairfax-county/springfield-va"}].map((a,i)=>(
            ...
            {["Tysons, VA","Oakton, VA","Reston, VA","Herndon, VA","Falls Church, VA"].map((c,i)=>(
