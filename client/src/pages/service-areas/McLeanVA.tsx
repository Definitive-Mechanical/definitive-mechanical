        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-8 items-center">
            ...
            <div className="hidden lg:block">
              <img src="https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=700&h=500&fit=crop&q=80" alt="Licensed plumber McLean Virginia — VA Master Plumber #2710064209 estate home service" loading="eager" className="rounded-lg w-full" style={{ objectFit:"cover", height:"420px" }} />
            </div>
          </div>
        </div>
      </section>
