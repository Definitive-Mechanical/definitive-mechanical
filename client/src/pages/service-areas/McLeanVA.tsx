  ...
  return (
    <>
      ...
      <section className="py-16" style={{ background:"var(--surface-1)" }}>
        <div className="container">
          <SectionHeading eyebrow="24/7 EMERGENCY SERVICE" heading="Do you provide 24/7 emergency plumbing in McLean?" />
          <div className="max-w-3xl mb-8">
            <p style={{ fontFamily:"'var(--font-body)'", color:"var(--ink-2)", fontSize:"16px", lineHeight:1.7 }}>
              Yes. Emergency plumbing in McLean is available 24/7. A live dispatcher answers every call. Licensed Virginia Master Plumber dispatched. No overtime surcharge. Call (301) 679-5849.
            </p>
          </div>
      ...
      <section className="py-12 bg-white">
        <div className="container">
          <SectionHeading eyebrow="NEARBY SERVICE AREAS" heading="Areas near McLean we also serve" />
          <div className="mb-3">
            ...
            {["Great Falls, VA","Tysons, VA","Falls Church, VA"].map((city, i) => (
      ...
      <section className="py-20" style={{ background:"var(--surface-1)" }}>
        <div className="container">
          <SectionHeading eyebrow="FREQUENTLY ASKED QUESTIONS" heading="Plumbing FAQ — McLean, VA" />
