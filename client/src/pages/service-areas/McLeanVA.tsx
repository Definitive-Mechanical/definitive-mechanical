...
const faqs = [
  { question: "What plumbing services do you offer in McLean, VA?", answer: "Full-service plumbing in McLean including emergency plumbing, water heater repair and installation, tankless water heaters, drain cleaning, sewer camera inspection, gas line installation for outdoor kitchens and generators, backflow certification for irrigation systems, and boiler service. Virginia licensed, SWaM certified. Call (301) 679-5849." },
  { question: "Do you provide 24/7 emergency plumbing in McLean?", answer: "Yes. Emergency service available 24/7. A live dispatcher answers every call. Licensed plumbing professionals dispatched — work performed under Master Plumber license. All services have a trip fee. Call (301) 679-5849." },
  { question: "Are you licensed to do plumbing in Fairfax County?", answer: "Yes. Virginia State Master Plumber/Gasfitter #2710064209 and Virginia Class A Contractor #2705181061 authorize all plumbing and gas work in McLean and throughout Fairfax County." },
  { question: "Do you certify backflow preventers for irrigation systems in McLean?", answer: "Yes. We provide annual irrigation backflow preventer testing and certification for McLean properties and can manage annual compliance scheduling. Call (301) 679-5849." },
];

export default function McLeanVA() {
  return (
    <>
      <Helmet>
        <title>Plumber in McLean, VA | 24/7 Emergency Plumbing | Definitive Mechanical</title>
        <meta name="description" content="Need a licensed plumber in McLean, VA? Definitive Mechanical provides 24/7 emergency plumbing, water heater repair, drain cleaning, gas line service & backflow certification. Call (301) 679-5849." />
        <link rel="canonical" href="https://definitivemechanical.com/service-areas/northern-virginia/fairfax-county/mclean-va/" />                <script type="application/ld+json" dangerouslySetInnerHTML={{__html: `{"@context": "https://schema.org", "@type": ["LocalBusiness", "Plumber"], "name": "Definitive Mechanical", "telephone": "+13016795849", "address": {"@type": "PostalAddress", "streetAddress": "9701 Apollo Drive, Suite 100", "addressLocality": "Largo", "addressRegion": "MD", "postalCode": "20774", "addressCountry": "US"}, "areaServed": {"@type": "City", "name": "McLean"}, "geo": {"@type": "GeoCoordinates", "latitude": 38.9339, "longitude": -77.1773}, "aggregateRating": {"@type": "AggregateRating", "ratingValue": "4.8", "reviewCount": "40"}}`}} />
        </Helmet>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-8 items-center">
            <div className="">
              ...
              <p style={{ fontFamily:"var(--font-body)", color:"rgba(255,255,255,0.85)", fontSize:"17px", maxWidth:"560px", lineHeight:1.7 }} className="mb-6">
                Definitive Mechanical provides licensed plumbing service in McLean, Virginia for estate homes, residential properties, and commercial facilities. Emergency plumbing, water heater repair, drain cleaning, gas line service, backflow certification, and sewer repair available 24/7. Virginia Master Plumber/Gasfitter #2710064209, Class A Contractor #2705181061. Call (301) 679-5849.
              </p>
              <TrustBadges variant="dark" badges={["VA Master Plumber/Gasfitter #2710064209","VA Class A Contractor #2705181061","VA SWaM Cert 815255","24/7 Emergency","Estate Home Experience"]} />
            ...
            <div className="block">
              <img src="/images/city-mclean-va.webp" alt="Licensed plumber McLean Virginia — VA Master Plumber #2710064209 estate home service" loading="eager" className="rounded-lg w-full city-hero-img" style={{ objectFit:"cover" }} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20" style={{ background:"#FAFBFC" }}>
        <div className="container">
          <SectionHeading eyebrow="LICENSED PLUMBING SERVICES" heading="What licensed plumbing services are available in McLean, VA?" />
          <p style={{ fontFamily:"var(--font-body)", color:"var(--ink-2)", fontSize:"16px", lineHeight:1.7 }} className="mb-8 max-w-3xl">
            McLean is one of the most affluent communities in Virginia — characterized by large estate homes, significant lot sizes, extensive landscaping with irrigation systems, outdoor entertainment areas, and a residential profile that creates demand for premium plumbing service. McLean's large homes have correspondingly complex plumbing systems — multiple water heaters or commercial-grade units, extensive irrigation systems with backflow requirements, gas lines serving outdoor kitchens and generators, and well-maintained but aging sewer laterals.
          </p>
      ...
      <section className="py-20" style={{ background:"#FAFBFC" }}>
        <div className="container">
          <SectionHeading eyebrow="LOCAL PLUMBING NEEDS" heading="What plumbing needs are most common for McLean homes?" />
      ...
      <section style={{ background:"#F4F7FA" }} className="py-16">
        <div className="container">
          ...
          <h2 style={{ fontFamily:"var(--font-display)", color: '#0A0A0A', fontSize:"clamp(22px,3vw,32px)", fontWeight:700, textTransform:"uppercase", lineHeight:1.1 }} className="mb-6">Areas Near McLean We Also Serve</h2>
          <div className="flex flex-wrap gap-2 mb-6">
            {[{label:"Arlington, VA",href:"/service-areas/northern-virginia/arlington-county/arlington-va"},{label:"Vienna, VA",href:"/service-areas/northern-virginia/fairfax-county/vienna-va"},{label:"Alexandria, VA",href:"/service-areas/northern-virginia/fairfax-county/alexandria-va"},{label:"Potomac, MD",href:"/service-areas/maryland/montgomery-county/potomac-md"}].map((a,i)=>(
              <a key={i} href={a.href} style={{ fontFamily:"var(--font-body)", fontSize:"14px", fontWeight:500, color:"var(--brand-navy)", background:"white", border:"1px solid #D0DCE8", borderRadius:"4px", padding:"6px 14px", textDecoration:"none", display:"inline-block" }}>{a.label}</a>
            ))}
            {["Great Falls, VA","Tysons, VA","Falls Church, VA"].map((c,i)=>(
