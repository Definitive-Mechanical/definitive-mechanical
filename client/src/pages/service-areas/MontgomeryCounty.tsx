...
const CITIES = [
  ...
  { name: "Silver Spring, MD", href: "/service-areas/maryland/", note: "Urban & suburban mix" },
  { name: "Gaithersburg, MD", href: "/service-areas/maryland/", note: "Tech corridor" },
  { name: "Germantown, MD", href: "/service-areas/maryland/", note: "Planned community" },
  { name: "Chevy Chase, MD", href: "/service-areas/maryland/", note: "DC border" },
  { name: "Takoma Park, MD", href: "/service-areas/maryland/", note: "Historic district" },
  { name: "Kensington, MD", href: "/service-areas/maryland/", note: "Established neighborhoods" },
  { name: "Wheaton, MD", href: "/service-areas/maryland/", note: "Commercial corridor" },
  { name: "Olney, MD", href: "/service-areas/maryland/", note: "Suburban north" },
  { name: "Clarksburg, MD", href: "/service-areas/maryland/", note: "New development" },
];
    ...
    <>
      ...
      <section style={{ background: "linear-gradient(135deg, #003060 0%, #001830 100%)", minHeight: "45vh" }} className="flex items-center py-16">
        <div className="container text-center">
          <BreadcrumbList items={[{ label: "Home", href: "/" }, { label: "Service Areas", href: "/service-areas/" }, { label: "Maryland", href: "/service-areas/maryland/" }, { label: "Montgomery County" }]} dark />
          <p className="mt-6 mb-3 uppercase tracking-widest text-xs font-bold" style={{ color: "#009EC6", fontFamily: "'Barlow Condensed', sans-serif" }}>PLUMBING SERVICES · MONTGOMERY COUNTY, MD</p>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-5" style={{ fontFamily: "'Playfair Display', serif" }}>Plumber in Montgomery County, MD</h1>
