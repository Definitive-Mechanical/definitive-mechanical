...
export default function UniversityParkMD() {
  return <Tier1CityPage
    ...
    heroImage="https://d2xsxph8kpxj0f.cloudfront.net/98106163/Mxa9FkjQjimhEb95Dyj8bk/university-park-md-YDVGkJvdNoTnNxftx4Ss9i.webp"
        cityMapQuery="University Park, MD"
    ctaCity="University Park"
    ctaLicenseLine="MD Master Plumber #96958 | WSSC #73696"
    faqs={[
      {q:"Are you licensed to work in University Park?",a:"Yes. University Park is served by WSSC. We hold Maryland State License #96958 and WSSC License #73696 for all permitted plumbing work."},
      {q:"What is the most common repair in University Park homes?",a:"Galvanized supply line repair and replacement — homes from the 1940s-1960s frequently need supply line updates as original pipes reach or exceed their service life."}
    ]}
  />;
}
