...
export default function CroomMD() {
  return <Tier1CityPage
    ...
    services={[
      ...
      {label:"Indoor plumbing for well-system properties (supply lines, pressure tanks, fixtures, water heaters)",href:""}
    ]}
    ...
    heroImage="https://d2xsxph8kpxj0f.cloudfront.net/98106163/Mxa9FkjQjimhEb95Dyj8bk/croom-md-AoVtcEU8QWrygKU6qjLPB4.webp"
