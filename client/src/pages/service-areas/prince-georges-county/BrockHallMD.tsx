...
export default function BrockHallMD() {
  return <Tier3CityPage
    ...
    schemaCity="Brock Hall" schemaState="MD"
    schemaUrl="https://definitivemechanical.com/service-areas/maryland/prince-georges-county/brock-hall-md/"
    breadcrumbs={[
      {label:"Home",href:"/"},
    ...
    services={[
      ...
      {label:"Gas Line Repair — including propane service",href:"/gas-line-repair/"},
