...
const SCHEMA = {
  ...
  "@graph": [
    ...
    { "@type": "FAQPage", "mainEntity": [
      ...
      {"@type":"Question","name":"Do you provide 24/7 emergency plumbing in Largo?","acceptedAnswer":{"@type":"Answer","text":"Yes. Definitive Mechanical is based in Largo, MD — emergency response here is among the fastest in our service area. A live dispatcher answers every call 24/7. Licensed Master Plumber dispatched immediately. All services have a trip fee."}},
...
const faqs = [
  ...
  { question: "Do you provide 24/7 emergency plumbing in Largo?", answer: "Yes. Definitive Mechanical is based in Largo, MD — emergency response here is among the fastest in our service area. A live dispatcher answers every call 24/7. Licensed Master Plumber dispatched immediately. All services have a trip fee." },
