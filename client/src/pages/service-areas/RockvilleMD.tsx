      ...
      <section style={{ background: "linear-gradient(135deg, var(--brand-navy) 0%, var(--brand-navy-dark) 100%)", minHeight: "60vh" }} className="py-20">
        <div className="container">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-8 items-center">
            ...
            <div className="block">
              <img src="/images/city-rockville-md.webp" alt="Rockville MD - licensed plumber serving Rockville Maryland" loading="eager" className="rounded-lg w-full city-hero-img" style={{ objectFit:"cover" }} />
            </div>
          </div>
        </div>
      </section>
