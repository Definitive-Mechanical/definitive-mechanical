  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Licensed plumbing services in Prince William County VA — Manassas, Woodbridge, Dale City, and beyond. VA Class A #2705-183416-A. 24/7 emergency. Call (301) 679-5849." />
      ...
      <section style={{ background: "linear-gradient(135deg, #003060 0%, #001830 100%)", minHeight: "45vh" }} className="flex items-center py-16">
        <div className="container text-center">
          <BreadcrumbList items={[{ label: "Home", href: "/" }, { label: "Service Areas", href: "/service-areas/" }, { label: "Northern Virginia", href: "/service-areas/northern-virginia/" }, { label: "Prince William County" }]} dark />
      ...
      <CTABanner heading="Need a plumber in Prince William County?" subtext="VA Class A #2705-183416-A · VA Master Plumber #2710-183416-A · 24/7 Emergency." primaryBtn={{ text: "📞 CALL (301) 679-5849", href: "tel:+13016795849" }} secondaryBtn={{ text: "REQUEST SERVICE", href: "/contact/" }} variant="gradient" />
    </>
  );
}
