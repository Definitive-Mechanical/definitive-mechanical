...
export default function IndependentHillVA() {
  return <Tier1CityPage
    ...
    introParagraph="Definitive Mechanical serves Independent Hill, Virginia — a community in Prince William County near Manassas and Woodbridge, featuring a mix of residential subdivisions and rural properties. We hold Virginia Master Plumber/Gasfitter License #2710064209 and are SWaM Certified."
    ...
    localContextHeading="Unique context for Independent Hill"
    localContextBody={"Independent Hill's mix of suburban and rural properties creates a range of plumbing service needs. Virginia License #2710064209 covers all permitted plumbing work in Prince William County."}
    ...
    heroImage="/images/independent-hill-va-FL9GKk7E6WpKq4a57GL9zH.webp"
