...
export default function DifficultRunVA() {
  return <Tier3CityPage
    ...
    metaDescription="Licensed plumber serving Difficult Run, VA. Plumbing, water heater, gas & emergency service for Difficult Run. VA #2710064008. Call (301) 679-5849."
    canonicalUrl="https://definitivemechanical.com/service-areas/northern-virginia/fairfax-county/difficult-run-va/"
    schemaCity="Difficult Run" schemaState="VA"
    schemaUrl="https://definitivemechanical.com/service-areas/northern-virginia/fairfax-county/difficult-run-va/"
    breadcrumbs={[
      {label:"Home",href:"/"},
    ...
    localContextBody={"The Difficult Run corridor's large custom homes often have complex propane systems, extensive irrigation requiring annual backflow certification, and long service line runs. Virginia License #2710064008 covers all permitted plumbing work in Fairfax County."}
    nearbyAreas={[
