...
export default function CrosspointeVA() {
  return <Tier1CityPage
    ...
    localContextBody={"Crosspointe's 1990s construction means original water heaters are well past their 10-15 year service life. Fairfax Water serves the community. Virginia License #2710064209 covers all permitted plumbing work in Fairfax County."}
    ...
    heroImage="/images/crosspointe-va-2PVhNUb6WzXjGkBavfjZni.webp"
