...
export default function FlorisVA() {
  return <Tier1CityPage
    ...
    introParagraph="Definitive Mechanical serves Floris, Virginia — a rural and semi-rural community in western Fairfax County near Herndon and Chantilly, with a mix of equestrian properties, custom homes on large lots, and newer residential subdivisions. We hold Virginia Master Plumber/Gasfitter License #2710064209 and are SWaM Certified."
    ...
    localContextBody={"Floris's large-lot properties often have complex propane systems and in-ground irrigation requiring annual backflow certification. Virginia License #2710064209 covers all permitted plumbing work in Fairfax County."}
    ...
    heroImage="/images/floris-va-9NiY9MxpsMZps44fme5mPU.webp"
