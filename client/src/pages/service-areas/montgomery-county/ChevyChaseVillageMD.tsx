...
export default function ChevyChaseVillageMD() {
  return <Tier1CityPage
    ...
    services={[
      ...
      {label:"Gas Line Repair — homes from this era commonly have original iron gas distribution",href:"/gas-line-repair/"},
      {label:"Water Line Repair — pre-war lead and galvanized service line replacement",href:"/water-line-repair/"},
      {label:"Video Camera Inspection — essential before any sewer recommendation on 100-year-old clay laterals",href:"/video-camera-inspection/"}
    ]}
    ...
    heroImage="https://d2xsxph8kpxj0f.cloudfront.net/98106163/Mxa9FkjQjimhEb95Dyj8bk/chevy-chase-village-md-HJDkrmBavtebdWPcVq6x9U.webp"
