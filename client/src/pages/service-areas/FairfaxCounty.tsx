    ...
    <>
      ...
      <section style={{ background: "linear-gradient(135deg, var(--brand-navy) 0%, var(--brand-navy-dark) 100%)", minHeight: "45vh" }} className="flex items-center py-16">
        <div className="container text-center">
          ...
          <p className="mt-6 mb-3 uppercase tracking-widest text-xs font-bold" style={{ color: "var(--brand-cyan)", fontFamily: "'Barlow Condensed', sans-serif" }}>PLUMBING SERVICES  FAIRFAX COUNTY, VA</p>
          ...
          <p className="text-white/85 text-lg max-w-2xl mx-auto mb-8" style={{ fontFamily: "'Barlow', sans-serif" }}>
            Definitive Mechanical provides licensed plumbing services throughout Fairfax County — McLean, Springfield, Vienna, Reston, Herndon, and all county communities. VA Class A #2705181061  VA Master Plumber #2710064209  SWaM Certified. 24/7 emergency. Call (301) 679-5849.
          </p>
