        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 mt-8 items-center">
            ...
            <div className="lg:col-span-2 hidden lg:block">
              <img src="https://placehold.co/700x500/186090/C0D8F0?text=Plumber+Ellicott+City+MD" alt="Licensed plumber Ellicott City Maryland — Howard County Master Plumber #MP-0000215" loading="eager" className="rounded-lg w-full" />
            </div>
          </div>
        </div>
      </section>
