...
const faqs = [
  ...
  { question: "Do you provide 24/7 emergency plumbing in Waldorf?", answer: "Yes. Emergency service available 24/7. We serve Waldorf from our Largo, MD location via MD-5/Branch Avenue. A live dispatcher answers every call. Licensed Master Plumber dispatched. All services have a trip fee. Call (301) 679-5849." },
    ...
    <>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-8 items-center">
            ...
            <div className="hidden lg:block">
              <img src="https://d2xsxph8kpxj0f.cloudfront.net/98106163/Mxa9FkjQjimhEb95Dyj8bk/city-page-hero-plumber-LiK4eLEJT6Nfxt9Ly3GS3e.webp" alt="Licensed plumber Waldorf Maryland — Definitive Mechanical" loading="eager" className="rounded-lg w-full" style={{ objectFit:"cover", height:"420px" }} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ background:"#F4F7FA" }} className="py-16">
        <div className="container">
          ...
          <h2 style={{ fontFamily:"var(--font-display)", color:"var(--brand-navy)", fontSize:"clamp(22px,3vw,32px)", fontWeight:700, textTransform:"uppercase", lineHeight:1.1 }} className="mb-6">Areas Near Waldorf, MD We Also Serve</h2>
