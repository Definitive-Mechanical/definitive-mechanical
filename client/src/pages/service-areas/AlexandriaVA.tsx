    ...
    <>
      ...
      <section style={{ background: "linear-gradient(135deg, var(--brand-navy) 0%, var(--brand-navy-dark) 100%)", minHeight: "60vh" }} className="py-20">
        <div className="container">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-8 items-center">
            ...
            <div className="block">
              <img src="/images/city-alexandria-va.webp" alt="Licensed plumber Alexandria Virginia — VA Master Plumber #2710064209, SWaM Certified" loading="eager" className="rounded-lg w-full city-hero-img" style={{ objectFit:"cover" }} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ background:"#F4F7FA" }} className="py-16">
        <div className="container">
          ...
          <h2 style={{ fontFamily:"var(--font-display)", color: '#0A0A0A', fontSize:"clamp(22px,3vw,32px)", fontWeight:700, textTransform:"uppercase", lineHeight:1.1 }} className="mb-6">Areas Near Alexandria, VA We Also Serve</h2>
          <div className="flex flex-wrap gap-2 mb-6">
            ...
            <a key="Springfield, VA" href="/service-areas/northern-virginia/fairfax-county/springfield-va" style={{ fontFamily:"var(--font-body)", fontSize:"14px", fontWeight:500, color:"var(--brand-navy)", background:"white", border:"1px solid #D0DCE8", borderRadius:"4px", padding:"6px 14px", textDecoration:"none", transition:"all 0.15s", display:"inline-block" }}>Springfield, VA</a>
      ...
      <CityMap
        q="Alexandria, VA"
        label="Alexandria, VA — Definitive Mechanical Service Area"
        zoom={13}
      />
