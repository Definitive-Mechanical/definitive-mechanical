  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
        {/* Hero Bar */}
        <div className="bg-[#003060] py-12 px-4">
          <div className="max-w-6xl mx-auto">
            <nav className="mb-4" aria-label="Breadcrumb">
              <ol className="flex items-center gap-1 font-['Barlow'] text-sm text-[#C0D8F0]">
            ...
            <p className="font-['Barlow'] text-[#C0D8F0] text-lg max-w-2xl">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-14">
            ...
            <div className="flex-1 min-w-0">
              {/* Featured Post */}
              <div className="mb-10">
                <p className="font-['Barlow_Condensed'] text-xs uppercase tracking-widest text-[#009EC6] mb-4">
                  Featured Article
                </p>
                <Link href={featured.href} className="group block border border-[#C0D8F0] rounded-sm overflow-hidden hover:border-[#009EC6] transition-colors" style={{ borderTop: "4px solid #009EC6" }}>
                  <div className="p-6 sm:p-8">
                    <div className="flex items-center gap-3 mb-4">
                      <span className="inline-flex items-center gap-1 bg-[#009EC6]/10 text-[#009EC6] font-['Barlow_Condensed'] font-bold text-xs uppercase tracking-wide px-3 py-1 rounded-sm">
                        <Zap className="w-3 h-3" />
                        {featured.category}
                      </span>
                      <span className="font-['Barlow'] text-[#787878] text-sm flex items-center gap-1">
                        <Clock className="w-3 h-3" />
                        {featured.readTime}
                      </span>
                      <span className="font-['Barlow'] text-[#787878] text-sm">{featured.date}</span>
                    </div>
                    <h2 className="font-['Playfair_Display'] text-2xl sm:text-3xl font-bold text-[#003060] mb-3 group-hover:text-[#009EC6] transition-colors leading-snug">
                      {featured.title}
                    </h2>
                    <p className="font-['Barlow'] text-[#484848] text-base leading-relaxed mb-5">
                      {featured.description}
                    </p>
                    <span className="font-['Barlow_Condensed'] font-bold text-sm uppercase tracking-wide text-[#009EC6] flex items-center gap-1">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {rest.map((post, i) => {
                    ...
                    return (
                      <Link key={i} href={post.href} className="group block border border-[#C0D8F0] rounded-sm overflow-hidden hover:border-[#009EC6] transition-colors" style={{ borderTop: "3px solid #009EC6" }}>
                        <div className="p-5">
                          <div className="w-9 h-9 bg-[#009EC6]/10 rounded-sm flex items-center justify-center mb-4">
                            <Icon className="w-4 h-4 text-[#009EC6]" />
                          </div>
                          <div className="flex items-center gap-2 mb-3">
                            <span className="font-['Barlow_Condensed'] font-bold text-xs uppercase tracking-wide text-[#009EC6]">
                              {post.category}
                            </span>
                            <span className="text-[#C0D8F0]">·</span>
                            <span className="font-['Barlow'] text-[#787878] text-xs flex items-center gap-1">
                              <Clock className="w-3 h-3" />
                              {post.readTime}
                            </span>
                          </div>
                          <h3 className="font-['Playfair_Display'] text-lg font-bold text-[#003060] mb-2 group-hover:text-[#009EC6] transition-colors leading-snug">
                            {post.title}
                          </h3>
                          <p className="font-['Barlow'] text-[#484848] text-sm leading-relaxed mb-4 line-clamp-3">
                            {post.description}
                          </p>
                  ...
                  <div className="divide-y divide-[#C0D8F0]">
                    {["Emergency Plumbing", "Cost Guide", "Buyer's Guide"].map((cat, i) => (
                      <div key={i} className="flex items-center justify-between px-4 py-3">
                        <span className="font-['Barlow'] text-[#484848] text-sm">{cat}</span>
                        <span className="font-['Barlow_Condensed'] font-bold text-xs text-[#009EC6]">
                  ...
                  <div className="divide-y divide-[#C0D8F0]">
                    {[
                      ...
                      <Link key={i} href={svc.href} className="flex items-center justify-between px-4 py-3 hover:bg-[#F0F7FF] transition-colors group">
                        <span className="font-['Barlow'] text-[#484848] text-sm group-hover:text-[#009EC6] transition-colors">{svc.title}</span>
                        <ArrowRight className="w-3 h-3 text-[#009EC6] opacity-0 group-hover:opacity-100 transition-opacity" />
                      </Link>
                    ))}
                  </div>
                </div>
        ...
        {/* Bottom CTA */}
        <div className="bg-[#003060] py-14 px-4 mt-4">
