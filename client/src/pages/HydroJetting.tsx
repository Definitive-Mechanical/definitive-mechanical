          ...
          <div className="grid lg:grid-cols-1 gap-12 items-center mt-6" style={{ maxWidth: '720px' }}>
            <div className="">
              ...
              <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', marginTop: '32px' }}>
                ...
                <BookNowButton bg="dark" variant="secondary" text="REQUEST HYDRO-JETTING" href="/contact" size="md" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section style={{ background: '#F0F5FA', padding: '80px 0' }}>
        <div className="container">
          ...
          <div style={{ textAlign: 'center' }}>
            <BookNowButton bg="blue" variant="phone" text="CALL FOR A DIRECT QUOTE" href="tel:+13016795849" size="md" />
          </div>
        </div>
      </section>
