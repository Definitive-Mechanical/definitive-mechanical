...
export default function WaterLineInstallation() {
  return (
    <>
      {/* SECTION 1: HERO */}
      <section style={{ minHeight: '46vh', background: 'linear-gradient(135deg, var(--brand-navy) 0%, var(--brand-blue) 100%)', display: 'flex', alignItems: 'center', position: 'relative', overflow: 'hidden' }}>
