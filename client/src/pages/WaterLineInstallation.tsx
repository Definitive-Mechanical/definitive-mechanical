...
export default function WaterLineInstallation() {
  return (
    <>
      {/* SECTION 1: HERO */}
      <section style={{ minHeight: '46vh', background: 'linear-gradient(135deg, #003060 0%, #186090 100%)', display: 'flex', alignItems: 'center', position: 'relative', overflow: 'hidden' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-3xl mx-auto">
            {WHEN_NEEDED.map((item, i) => (
              <div key={item} style={{ display: 'flex', gap: '10px', alignItems: 'flex-start', padding: '12px', background: '#F8FAFC', borderRadius: '4px', border: '1px solid #E8EFF5' }}>
                <CheckCircle2 size={16} color="#009EC6" style={{ flexShrink: 0, marginTop: '2px' }} />
      ...
      <section style={{ background: '#F0F0F0', padding: '64px 0' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <img src="https://images.unsplash.com/photo-1621905251189-08b45d6a269e?w=600&q=80" alt="Commercial water line installation Maryland DC Virginia — Definitive Mechanical" style={{ width: '100%', borderRadius: '6px', boxShadow: '0 4px 20px rgba(0,48,96,0.12)' }} />
            </div>
            <div>
              <p className="eyebrow mb-2">COMMERCIAL & GOVERNMENT</p>
              <h2 style={{ fontFamily: 'Playfair Display, Georgia, serif', fontWeight: 700, color: '#003060', fontSize: 'clamp(20px, 2.5vw, 26px)', marginBottom: '16px' }}>Do you install water lines for commercial and government properties?</h2>
