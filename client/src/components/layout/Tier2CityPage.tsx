...
function FAQAccordionItem({ q, a }: { q: string; a: string }) {
  ...
  return (
    <div className="border-b border-[#C0D8F0]">
      ...
      >
        <span style={{ fontFamily: 'var(--font-body)' }} className="font-medium text-[var(--brand-navy)] text-base leading-snug">{q}</span>
      ...
      {open && (
        <div className="border-l-4 border-[var(--brand-cyan)] bg-[#EAF4FA] px-5 py-4 mb-2">
          <p style={{ fontFamily: 'var(--font-body)' }} className="text-[var(--ink-2)] text-base leading-[1.75]">{a}</p>
        </div>
      )}
    </div>
  );
    ...
    <>
      ...
      <div className="bg-[#F0F0F0] py-2 px-4 border-b border-[#C0D8F0]">
        <div className="max-w-5xl mx-auto">
          <nav style={{ fontFamily: 'var(--font-body)' }} className="text-sm text-[#787878] flex flex-wrap gap-1 items-center">
      ...
      <section className="bg-white py-14 px-4 border-b border-[#C0D8F0]">
        <div className="max-w-5xl mx-auto">
          <p style={{ fontFamily: 'var(--font-label)' }} className="text-xs font-bold uppercase tracking-widest text-[var(--brand-cyan)] mb-3">
            {eyebrow}
          </p>
          ...
          <p style={{ fontFamily: 'var(--font-body)' }} className="text-[var(--ink-2)] text-[17px] leading-[1.75] mb-8 max-w-3xl">
            {introParagraph}
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            <a
              href="tel:+13016795849"
              className="flex items-center justify-center gap-2 bg-[var(--brand-cyan)] text-[var(--brand-navy)] py-4 px-8 rounded-sm hover:bg-[var(--brand-blue-hover)] transition-colors"
              style={{ fontFamily: 'var(--font-label)', fontWeight: 700, fontSize: "18px", textTransform: "uppercase", letterSpacing: "0.05em" }}
            >
      ...
      <section className="bg-[#C0D8F0] py-4 px-4 overflow-x-auto">
        <div className="max-w-5xl mx-auto flex flex-wrap gap-x-6 gap-y-2 items-center">
          {trustItems.map((item) => (
            <span key={item} style={{ fontFamily: 'var(--font-label)' }} className="text-[var(--brand-navy)] font-bold text-sm uppercase tracking-wide whitespace-nowrap">
              {item}
            </span>
          ))}
        </div>
      ...
      <section className="bg-[#F0F0F0] py-14 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div style={{ fontFamily: 'var(--font-body)' }} className="text-[var(--ink-2)] text-[17px] leading-[1.75] max-w-3xl space-y-4">
      ...
      <section className="bg-white py-14 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <p style={{ fontFamily: 'var(--font-body)' }} className="text-[var(--ink-2)] text-[17px] mb-6">Yes. We hold the following credentials for this jurisdiction:</p>
      ...
      <section className="bg-[#C0D8F0] py-12 px-4">
        <div className="max-w-5xl mx-auto">
          <h3
            style={{ fontFamily: 'var(--font-label)', color: "var(--brand-blue)" }}
      ...
      <section className="py-14 px-4" style={{ background: 'linear-gradient(135deg, var(--brand-blue-hover), var(--brand-blue))' }}>
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
            <a
              href="tel:+13016795849"
              className="flex items-center justify-center gap-2 bg-[var(--brand-cyan)] text-[var(--brand-navy)] py-4 px-8 rounded-sm hover:bg-[var(--brand-blue-hover)] transition-colors w-full sm:w-auto"
              style={{ fontFamily: 'var(--font-label)', fontWeight: 700, fontSize: "18px", textTransform: "uppercase", letterSpacing: "0.05em" }}
            >
              <Phone className="w-5 h-5" />
              (301) 679-5849
          ...
          <p style={{ fontFamily: 'var(--font-body)' }} className="text-[#C0D8F0] text-sm">
            {ctaLicenseLine}
          </p>
        </div>
      </section>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 lg:hidden">
        <a
          ...
          style={{ fontFamily: 'var(--font-label)', fontWeight: 700, fontSize: "16px", textTransform: "uppercase", letterSpacing: "0.05em" }}
        >
